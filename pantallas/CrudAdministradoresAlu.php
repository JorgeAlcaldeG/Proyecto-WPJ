  ...
  <tbody>
   ...
   $tabla=<<<wxt
    <tr>
      ...
      <span>
            <svg class="svg2" xmlns="http://www.w3.org/2000/svg" onclick="window.location.href='Modify.php?var={$dato['id_alumne']}'" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
