...
if (empty($_POST['Nie'])) {
    ...
    if ($foto['size']<200*1024 && $foto['type']="image/jpeg" || $foto['type']="image/png" || $foto['type']="image/gif") {
        if (move_uploaded_file($foto['tmp_name'],$destinolocal)) {
            ...
            $sql = "INSERT INTO tbl_professor (`nom_prof`, `cognom1_prof`, `cognom2_prof`, `email_prof`, `telf`, `dept`, `passwd`, `img_prof`) VALUES ('$nombre', '$apellido', '$apellido2', '$email', '$telf', '$curso', '$psw', '$destinored');";
